  ...
  const games: Game[] = [
    {
      ...
      name: "Pattern Master",
      description:
        "Identify complex patterns and sequences to test logical thinking",
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-300">
                Showcase your skills, climb leaderboards, unlock exclusive jobs
              </p>
            </div>
            <Button
              onClick={() => navigate("/")}
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <Tabs defaultValue="games" className="space-y-8">
          <TabsList className="grid w-full grid-cols-3 bg-[#40444b] max-w-md">
            <TabsTrigger
              value="games"
              className="text-white data-[state=active]:bg-[#404EED]"
            >
              Games
            </TabsTrigger>
            <TabsTrigger
          ...
          <TabsContent value="games" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {games.map((game) => (
                <Card
                  key={game.id}
                  className={`bg-[#2f3136] border-gray-700 hover:bg-[#32363b] transition-colors cursor-pointer ${
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div className="text-purple-400">{game.icon}</div>
                        <div>
                  ...
                  {[
                    {
                      ...
                      desc: "Score 8000+ in Pattern Master",
                      unlocked: true,
                    },
                    {
                      icon: "🧠",
                      title: "Memory Champion",
                      desc: "Perfect score in Memory Matrix",
                      unlocked: true,
                    },
                    {
                      icon: "⚡",
                      title: "Speed Demon",
                      desc: "Complete Speed Math in under 90s",
                      unlocked: false,
                    },
                    {
                      icon: "🎯",
                      title: "Strategic Mind",
                      desc: "Win 5 Strategy games in a row",
                      unlocked: false,
                    },
