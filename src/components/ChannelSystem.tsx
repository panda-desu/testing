...
import { Hash, Users, MessageSquare, ThumbsUp, Send, UserPlus, UserMinus, Crown } from 'lucide-react';
...
const ChannelSystem = () => {
  ...
  const [comments, setComments] = useState<Comment[]>([
    {
      ...
      channelId: 'general',
      user: 'TechNinja_MN',
      message: '🔥 Just landed a remote job at a US company! The AI matching here is insane!',
    ...
    },
    {
      ...
      channelId: 'tech-jobs',
      user: 'AIEnthusiast',
      message: 'MongoDB is hiring junior devs! No degree required, just skills 💪',
    ...
    setChannels(prev => prev.map(channel => 
      channel.id === channelId 
        ? { 
            ...
            memberCount: channel.isJoined ? channel.memberCount - 1 : channel.memberCount + 1
          }
        : channel
    ));
  };
  ...
  const channelComments = comments.filter(c => c.channelId === selectedChannel);

  return (
    <div className="bg-[#36393f] min-h-screen">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h2 className="text-4xl font-black text-white mb-4">Job Communities</h2>
          <p className="text-gray-300 text-lg">Join channels, network, and discover opportunities</p>
        </div>
              ...
              <div className="space-y-3">
                {channels.map(channel => (
                  <div key={channel.id} className="group">
                    ...
                    {channel.isJoined && (
                      <Badge variant="secondary" className="ml-7 mt-1 text-xs bg-green-600">
                        Member
                      </Badge>
                    )}
                  </div>
            ...
            {selectedChannel ? (
              <div className="bg-[#2f3136] rounded-lg border border-gray-700 h-[600px] flex flex-col">
                    ...
                    <div key={comment.id} className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          {comment.user === 'TechNinja_MN' && <Crown className="w-4 h-4 text-yellow-500" />}
                        ...
                        <Button
                          ...
                          className={`mt-2 text-xs ${comment.isLiked ? 'text-red-400' : 'text-gray-400'}`}
                        >
                ...
                <div className="p-4 border-t border-gray-700">
                  <div className="flex space-x-2">
                    ...
                    />
                    <Button onClick={addComment} className="bg-[#404EED] hover:bg-[#404EED]/90">
              ...
              <div className="bg-[#2f3136] rounded-lg border border-gray-700 h-[600px] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-400">Choose a channel to start chatting and networking</p>
                </div>
              </div>
            )}
          </div>
