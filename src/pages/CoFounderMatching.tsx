...
const CoFounderMatching = () => {
  ...
  const filteredCoFounders = coFounders.filter((coFounder) => {
    ...
    const matchesLocation =
      !locationFilter || coFounder.location.includes(locationFilter);
    const matchesSkill =
      !skillFilter ||
    ...
    const matchesIndustry =
      !industryFilter || coFounder.industries.includes(industryFilter);
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          <TabsList className="bg-[#2f3136] border border-gray-700">
            <TabsTrigger
              value="discover"
              className="text-gray-300 data-[state=active]:text-white data-[state=active]:bg-[#404EED]"
            >
          ...
          <TabsContent value="discover" className="space-y-6">
            ...
            <Card className="bg-[#2f3136] border-gray-700">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <Input
                    placeholder="Skills (e.g., Rsieact, Sales)"
                    value={skillFilter}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredCoFounders.map((coFounder) => (
                <Card
                  key={coFounder.id}
                  className="bg-[#2f3136] border-gray-700 hover:bg-[#32363b] transition-all"
                >
            ...
            <Card className="bg-[#2f3136] border-gray-700">
              <CardHeader>
                ...
                <p className="text-gray-400">
                  Co-founders who are interested in connecting with you
                </p>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {matches.map((match) => (
                    <Card
                      key={match.id}
                      className="bg-[#40444b] border-gray-600"
                    >
                      <CardContent className="p-4">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            className="border-gray-600 text-gray-700 hover:text-gray-300"
                          >
                            View Profile
                          </Button>
                        </div>
          ...
          <TabsContent value="connections" className="space-y-6">
            <Card className="bg-[#2f3136] border-gray-700">
              <CardHeader>
                ...
                <p className="text-gray-400">
                  Co-founders you're already connected with
                </p>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {connections.map((connection) => (
                    <div
                      key={connection.id}
                      className="flex items-center justify-between p-4 bg-[#40444b] rounded-lg border border-gray-600"
                    >
                      <div className="flex items-center space-x-3">
                        <Avatar className="w-12 h-12">
